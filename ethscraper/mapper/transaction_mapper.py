from ethscraper.domain.transaction import EthTransaction
...
class EthTransactionMapper(object):
    ...
    def transaction_to_dict(self, transaction):
        return {
            ...
            'tx_blockHash': transaction.block_hash,
            'tx_blockNumber': transaction.block_number,
            'tx_transactionIndex': transaction.index,
            'tx_from': transaction.from_address,
            'tx_to': transaction.to_address,
            'tx_value': transaction.value,
            'tx_gas': transaction.gas,
            'tx_gasPrice': transaction.gas_price,
